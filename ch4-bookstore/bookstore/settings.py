...
from environs import Env # used to work with environment variables
...
SECRET_KEY = 'django-insecure-oq0bf%12p__36toq$y2ul#z6mi7tt@ph#t%^w3&p+0^js!-vdw'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # the templates directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
